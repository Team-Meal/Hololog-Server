...
class CreateSignupRequestServiceTest :
    BehaviorSpec({
        ...
        val request = CreateSignupRequestRequest(licenseNumber = 123456789L)
        ...
        Given("인증된 회원이 면허번호를 제출할 때") {
            ...
            When("가입 요청을 생성하면") {
                ...
                Then("현재 회원과 연결된 PENDING 요청이 생성되고 응답으로 반환된다") {
                    ...
                    savedSlot.captured.licenseNumber shouldBe 123456789L
                    savedSlot.captured.status shouldBe SignupStatus.PENDING
                    response.licenseNumber shouldBe 123456789L
